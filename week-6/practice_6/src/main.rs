fn main() {
    ...
    println!();
    println!("{} is aimed at development competent, creative, innovative, entrepreneurial and ethically-minded person, capable of creating value in the diverse fields of computer science. ", w3);
}